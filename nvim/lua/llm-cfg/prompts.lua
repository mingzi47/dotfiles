...
M.TestCode = [[Write some test cases for the following code, only return the test cases.
...
M.CodeExplain = "Explain the following code, please only return the explanation, and answer in Chinese"

M.CommitMsg = function()
